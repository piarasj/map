...
// Update the showWelcomeExperience method to include a close button
  ...
  const welcomeHTML = `
    <div id="welcome-overlay" class="welcome-overlay">
      <div class="welcome-content">
        ...
        <button id="close-welcome" class="welcome-close-btn" aria-label="Close welcome overlay" onclick="console.log('Direct click!'); document.getElementById('welcome-overlay').remove();">
        ...
        <div class="welcome-description">
          ...
          <p>Taking list, showing maps. You're seeing Irish counties and dioceses as an example - you haven't loaded any markers.<br>Hover over a filled area to see its description. Use the buttons below or the shortcut keys to show area, borders or none - o for counties, i for dioceses.</p>
        </div>
...
// Update the addWelcomeStyles method to include close button styles
...
// Update the bindWelcomeEvents method to include close button handler
